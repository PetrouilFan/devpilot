...
export const TypeId: TypeId = "~@devpilot-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@devpilot-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@devpilot-ai/effect-sqlite-node/NodeSqliteClient")
