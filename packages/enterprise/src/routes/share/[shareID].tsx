import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@devpilot-ai/sdk/v2"
import { SessionTurn } from "@devpilot-ai/ui/session-turn"
import { SessionReview } from "@devpilot-ai/ui/session-review"
import { DataProvider } from "@devpilot-ai/ui/context"
import { FileComponentProvider } from "@devpilot-ai/ui/context/file"
import { WorkerPoolProvider } from "@devpilot-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@devpilot-ai/ui/logo"
import { IconButton } from "@devpilot-ai/ui/icon-button"
import { ProviderIcon } from "@devpilot-ai/ui/provider-icon"
import { iife } from "@devpilot-ai/core/util/iife"
import { Binary } from "@devpilot-ai/core/util/binary"
import { NamedError } from "@devpilot-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@devpilot-ai/ui/tabs"
import { MessageNav } from "@devpilot-ai/ui/message-nav"
import { FileSSR } from "@devpilot-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@devpilot-ai/ui/pierre/worker").then((m) => ({
