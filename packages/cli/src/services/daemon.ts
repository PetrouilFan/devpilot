...
import { createOpencodeClient } from "@devpilot-ai/sdk/v2/client"
import { ServerAuth } from "@devpilot-ai/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@devpilot/cli/Daemon") {}
