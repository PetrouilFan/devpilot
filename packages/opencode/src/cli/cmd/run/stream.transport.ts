...
import type { Event, GlobalEvent, OpencodeClient } from "@devpilot-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@devpilot/RunStreamTransport") {}
