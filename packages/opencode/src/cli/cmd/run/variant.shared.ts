...
//
// The saved variant persists across sessions in ~/.local/state/devpilot/model.json
...
class Service extends Context.Service<Service, VariantService>()("@devpilot/RunVariant") {}
