...
>()("@devpilot/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@devpilot/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.DEVPILOT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.DEVPILOT_WORKSPACE_ID) : undefined
}
