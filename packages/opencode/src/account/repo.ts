...
import { AccountStateTable, AccountTable } from "@devpilot-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@devpilot/AccountRepo") {}
