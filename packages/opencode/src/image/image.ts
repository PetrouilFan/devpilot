...
export class Service extends Context.Service<Service, Interface>()("@devpilot/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __DEVPILOT_PHOTON_WASM_PATH?: string }).__DEVPILOT_PHOTON_WASM_PATH =
