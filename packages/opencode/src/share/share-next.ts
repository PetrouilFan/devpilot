...
import type * as SDK from "@devpilot-ai/sdk/v2"
...
import { SessionShareTable } from "@devpilot-ai/core/share/sql"
...
const disabled = process.env["DEVPILOT_DISABLE_SHARE"] === "true" || process.env["DEVPILOT_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@devpilot/ShareNext") {}
