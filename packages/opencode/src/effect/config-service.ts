 ...
 *   "@devpilot/ServerAuthConfig",
 *   {
 *     password: Config.string("DEVPILOT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("DEVPILOT_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
