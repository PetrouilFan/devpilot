...
import { EventSequenceTable, EventTable } from "@devpilot-ai/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@devpilot/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        DEVPILOT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        DEVPILOT_WORKSPACE_ID: config.id,
        DEVPILOT_EXPERIMENTAL_WORKSPACES: "true",
