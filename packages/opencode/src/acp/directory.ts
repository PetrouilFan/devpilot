...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@devpilot/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@devpilot/ACPDirectory") {}
