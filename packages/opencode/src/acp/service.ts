...
import type { Message, OpencodeClient, SessionMessageResponse } from "@devpilot-ai/sdk/v2"
...
export class Service extends Context.Service<Service, Interface>()("@devpilot/ACP/Service") {}
