...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@devpilot-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@devpilot/ToolRegistry") {}
