...
const MANAGED_PLIST_DOMAIN = "ai.devpilot.managed"
...
function systemManagedConfigDir(): string {
  switch (process.platform) {
    case "darwin":
      return "/Library/Application Support/devpilot"
    case "win32":
...
export function managedConfigDir() {
  return process.env.DEVPILOT_TEST_MANAGED_CONFIG_DIR || systemManagedConfigDir()
}
