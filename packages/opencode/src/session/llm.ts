...
import { llmClient } from "@devpilot-ai/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@devpilot-ai/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@devpilot-ai/llm/route"
import type { LLMClientService } from "@devpilot-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@devpilot/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @devpilot-ai/llm. It
