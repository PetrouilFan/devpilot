import type { JsonSchema, LLMRequest, ProviderMetadata } from "@devpilot-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@devpilot-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @devpilot-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
