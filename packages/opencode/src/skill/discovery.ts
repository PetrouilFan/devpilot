...
import { httpClient, path } from "@devpilot-ai/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@devpilot/SkillDiscovery") {}
