...
import { SkillPlugin } from "@devpilot-ai/core/plugin/skill"
import { Permission } from "@/permission"
import { FSUtil } from "@devpilot-ai/core/fs-util"
import { Config } from "@/config/config"
import { FrontmatterError } from "@devpilot-ai/core/v1/config/error"
...
const DEVPILOT_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
...
const CUSTOMIZE_DEVPILOT_SKILL_NAME = "customize-devpilot"
const CUSTOMIZE_DEVPILOT_SKILL_DESCRIPTION =
...
const CUSTOMIZE_DEVPILOT_SKILL_BODY = SkillPlugin.CustomizeOpencodeContent
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, DEVPILOT_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@devpilot/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_DEVPILOT_SKILL_NAME] = {
          name: CUSTOMIZE_DEVPILOT_SKILL_NAME,
          description: CUSTOMIZE_DEVPILOT_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_DEVPILOT_SKILL_BODY,
        }
