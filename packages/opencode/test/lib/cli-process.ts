...
//   - DEVPILOT_CONFIG_CONTENT      : provider config inline, no files to find
//   - DEVPILOT_TEST_HOME           : pins os.homedir() → tmpdir
//   - DEVPILOT_DISABLE_PROJECT_CONFIG : skip walking up for opencode.json
//   - DEVPILOT_PURE                : skip external plugin discovery + install
//   - DEVPILOT_DISABLE_AUTOUPDATE / AUTOCOMPACT / MODELS_FETCH : no background work
...
function isolatedEnv(home: string, configJson: string): Record<string, string> {
  return {
    DEVPILOT_TEST_HOME: home,
    HOME: home,
    XDG_CONFIG_HOME: path.join(home, ".config"),
    XDG_DATA_HOME: path.join(home, ".local/share"),
    XDG_STATE_HOME: path.join(home, ".local/state"),
    XDG_CACHE_HOME: path.join(home, ".cache"),
    DEVPILOT_CONFIG_CONTENT: configJson,
    DEVPILOT_DISABLE_PROJECT_CONFIG: "1",
    DEVPILOT_PURE: "1",
    DEVPILOT_DISABLE_AUTOUPDATE: "1",
    DEVPILOT_DISABLE_AUTOCOMPACT: "1",
    DEVPILOT_DISABLE_MODELS_FETCH: "1",
    DEVPILOT_AUTH_CONTENT: "{}",
  }
}
