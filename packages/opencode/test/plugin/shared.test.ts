...
describe("parsePluginSpecifier", () => {
  ...
  test("parses scoped npm package without version", () => {
    expect(parsePluginSpecifier("@devpilot/acme")).toEqual({
      pkg: "@devpilot/acme",
      version: "latest",
    })
  })
  ...
  test("parses scoped npm package with version", () => {
    expect(parsePluginSpecifier("@devpilot/acme@1.0.0")).toEqual({
      pkg: "@devpilot/acme",
      version: "1.0.0",
    })
  })
  ...
  test("parses scoped package with git+https url", () => {
    expect(parsePluginSpecifier("@devpilot/acme@git+https://github.com/opencode/acme.git")).toEqual({
      pkg: "@devpilot/acme",
      version: "git+https://github.com/opencode/acme.git",
    })
  })
  ...
  test("parses scoped package with git+ssh url containing another @", () => {
    expect(parsePluginSpecifier("@devpilot/acme@git+ssh://git@github.com/opencode/acme.git")).toEqual({
      pkg: "@devpilot/acme",
      version: "git+ssh://git@github.com/opencode/acme.git",
    })
  })
