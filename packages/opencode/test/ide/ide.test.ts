...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders DEVPILOT_CALLER", () => {
    process.env["DEVPILOT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode DEVPILOT_CALLER", () => {
    process.env["DEVPILOT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown DEVPILOT_CALLER", () => {
    process.env["DEVPILOT_CALLER"] = "unknown"
