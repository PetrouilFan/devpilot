...
const releaseId = process.env.DEVPILOT_RELEASE
if (!releaseId) throw new Error("DEVPILOT_RELEASE is required")

const version = process.env.DEVPILOT_VERSION
if (!version) throw new Error("DEVPILOT_VERSION is required")
