export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de DevPilot",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de DevPilot. ¿Quieres instalarla y reiniciar?",
