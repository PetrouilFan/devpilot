...
} from "@devpilot-ai/plugin/tui"
import { AttentionSoundName, type TuiConfig } from "./config"
import { Schema } from "effect"
import stripAnsi from "strip-ansi"
import * as TuiAudio from "./audio"
import defaultSoundPath from "@devpilot-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@devpilot-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@devpilot-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@devpilot-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@devpilot-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@devpilot-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "DevPilot"
const DEFAULT_PACK_ID = "devpilot.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "DevPilot Default",
  builtin: true,
  sounds: {
