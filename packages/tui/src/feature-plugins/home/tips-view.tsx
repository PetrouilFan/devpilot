import type { TuiPluginApi } from "@devpilot-ai/plugin/tui"
...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at devpilot.ai",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.devpilot/commands/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.devpilot/agents/{/highlight} for specialized AI personas",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.devpilot/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.devpilot/plugins/{/highlight} for event hooks",
  ...
  "Use {highlight}/devpilot{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}devpilot github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/devpilot fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/oc{/highlight} on PR code lines for targeted code reviews",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in {highlight}.devpilot/themes/{/highlight} directory",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/devpilot{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with DevPilot Zen for curated, tested models",
