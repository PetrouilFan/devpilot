...
import type { PermissionRequest } from "@devpilot-ai/sdk/v2"
...
import { DEVPILOT_BASE_MODE, useBindings, useCommandShortcut } from "../../keymap"
            ...
            <Switch>
              ...
              <Match when={true}>
                <box paddingLeft={1} gap={1}>
                  <text fg={theme.textMuted}>This will allow the following patterns until DevPilot is restarted</text>
                  <box>
