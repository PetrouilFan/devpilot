...
class Database extends Context.Service<Database, DatabaseShape>()("@devpilot/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@devpilot/example/UserStore") {
