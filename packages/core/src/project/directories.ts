...
import type { EffectDrizzleSqlite } from "@devpilot-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@devpilot/ProjectDirectories") {}
