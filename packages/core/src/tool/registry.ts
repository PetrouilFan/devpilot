...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@devpilot-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@devpilot/v2/ToolRegistry") {}
