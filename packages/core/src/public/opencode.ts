export * as DevPilot from "./opencode"
...
/** Intentional public native API for Effect applications embedding DevPilot. */
export class Service extends Context.Service<Service, Interface>()("@devpilot/public/OpenCode") {}
...
>()("@devpilot/public/OpenCode/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("DevPilot.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("DevPilot.sessions.switchModel")(function* (input) {
...
// TODO: Add DevPilot.create(...) as the Promise facade over the same native API semantics.
