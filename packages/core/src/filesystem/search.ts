...
export class Service extends Context.Service<Service, Interface>()("@devpilot/v2/FileSystem/Search") {}
...
export const defaultLayer = Layer.unwrap(
  Effect.sync(() => (Flag.DEVPILOT_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
