...
declare const DEVPILOT_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof DEVPILOT_LIBC === "undefined" ? undefined : DEVPILOT_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@devpilot/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.DEVPILOT_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.DEVPILOT_EXPERIMENTAL_FILEWATCHER) {
