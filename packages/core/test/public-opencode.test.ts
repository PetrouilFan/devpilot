...
import { AbsolutePath, Location, Model, DevPilot, Session, Tool } from "@devpilot-ai/core/public"
import { tmpdir } from "./fixture/tmpdir"
import { testEffect } from "./lib/effect"

const it = testEffect(DevPilot.layer)

describe("public native DevPilot API", () => {
  it.effect("exposes only the intentional Session capabilities", () =>
    Effect.gen(function* () {
      const opencode = yield* DevPilot.Service
