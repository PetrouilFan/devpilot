...
import {
  ...
  type LLMClientShape,
  type LLMRequest,
} from "@devpilot-ai/llm"
import * as OpenAIChat from "@devpilot-ai/llm/protocols/openai-chat"
import { Database } from "@devpilot-ai/core/database/database"
import { EventV2 } from "@devpilot-ai/core/event"
import { PermissionV2 } from "@devpilot-ai/core/permission"
import { EventTable } from "@devpilot-ai/core/event/sql"
import { Project } from "@devpilot-ai/core/project"
import { ProjectTable } from "@devpilot-ai/core/project/sql"
import { QuestionV2 } from "@devpilot-ai/core/question"
import { AbsolutePath } from "@devpilot-ai/core/schema"
import { SessionV2 } from "@devpilot-ai/core/session"
import { ContextSnapshotDecodeError } from "@devpilot-ai/core/session/error"
import { SessionEvent } from "@devpilot-ai/core/session/event"
import { SessionInput } from "@devpilot-ai/core/session/input"
import { SessionMessage } from "@devpilot-ai/core/session/message"
import { Prompt } from "@devpilot-ai/core/session/prompt"
import { SessionProjector } from "@devpilot-ai/core/session/projector"
import { SessionExecution } from "@devpilot-ai/core/session/execution"
import { SessionContextEpoch } from "@devpilot-ai/core/session/context-epoch"
import { SessionRunCoordinator } from "@devpilot-ai/core/session/run-coordinator"
import { SessionRunner } from "@devpilot-ai/core/session/runner"
import * as SessionRunnerLLM from "@devpilot-ai/core/session/runner/llm"
import { SessionRunnerModel } from "@devpilot-ai/core/session/runner/model"
import { ToolRegistry } from "@devpilot-ai/core/tool/registry"
import { ToolOutputStore } from "@devpilot-ai/core/tool-output-store"
import { ApplicationTools } from "@devpilot-ai/core/tool/application-tools"
import { AgentV2 } from "@devpilot-ai/core/agent"
import { Config } from "@devpilot-ai/core/config"
import { ConfigCompaction } from "@devpilot-ai/core/config/compaction"
import { Tool } from "@devpilot-ai/core/tool/tool"
import {
  SessionContextEpochTable,
  SessionInputTable,
  SessionMessageTable,
  SessionTable,
} from "@devpilot-ai/core/session/sql"
import { SessionStore } from "@devpilot-ai/core/session/store"
import { SystemContext } from "@devpilot-ai/core/system-context"
import { SystemContextRegistry } from "@devpilot-ai/core/system-context/registry"
import { SkillGuidance } from "@devpilot-ai/core/skill/guidance"
import { ReferenceGuidance } from "@devpilot-ai/core/reference/guidance"
