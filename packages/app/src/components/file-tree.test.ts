...
beforeAll(async () => {
  ...
  mock.module("@devpilot-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@devpilot-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@devpilot-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@devpilot-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
