export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by DevPilot",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in DevPilot.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "DevPilot Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in DevPilot.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in DevPilot.",
  ...
  "dialog.server.description": "Switch which DevPilot server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "DevPilot",
  ...
  "wsl.onboarding.checkingDevpilot": "Checking DevPilot...",
  "wsl.onboarding.checkingDevpilotIn": "Checking DevPilot in {{distro}}...",
  "wsl.onboarding.updatingDevpilot": "Updating DevPilot...",
  "wsl.onboarding.updatingDevpilotIn": "Updating DevPilot in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update DevPilot in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update DevPilot",
  "wsl.onboarding.opencodeReadyIn": "DevPilot is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "DevPilot is ready.",
  "wsl.onboarding.installOpencodeIn": "Install DevPilot in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install DevPilot",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen DevPilot.",
  ...
  "toast.update.description": "A new version of DevPilot ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the DevPilot team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, DevPilot does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "DevPilot includes free models so you can start immediately.",
  ...
  "app.name.desktop": "DevPilot Desktop",
  ...
  "settings.desktop.wsl.description": "Run the DevPilot server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for DevPilot",
  ...
  "settings.general.row.appearance.description": "Customise how DevPilot looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether DevPilot follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how DevPilot is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when DevPilot launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of DevPilot.",
