...
Generates UPCOMING_CHANGELOG.md by running the devpilot changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
    --variant <name>   Thinking variant for devpilot run (default: low)
    --quiet            Suppress devpilot command output unless it fails
